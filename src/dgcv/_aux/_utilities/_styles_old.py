...
style_guide = {
    ...
    "slate_and_copper": {
        "table": {"props": [("border", "1px solid #b87333")]},
        "header": {
            "props": [
        ...
        "row_heading": {
            "props": [("background-color", "#2f3e46"), ("color", "#b87333")]
        },
        "row": {"props": [("background-color", "#2f3e46"), ("color", "#cad2c5")]},
        "alt_row": {"props": [("background-color", "#354f52")]},
        "hover": {
            "props": [
                ("background-color", "#b87333"),
                ("color", "#2f3e46"),
    ...
    "foggy_lights": {
        "table": {"props": [("border", "1px solid #778899")]},
        "header": {
            "props": [
        ...
        "row_heading": {
            "props": [("background-color", "#f8f9fa"), ("color", "#4682b4")]
        },
        "row": {"props": [("background-color", "#f8f9fa"), ("color", "#495057")]},
        "alt_row": {"props": [("background-color", "#e9ecef")]},
        "hover": {
            "props": [
    ...
    "forest_floor": {
        "table": {"props": [("border", "1px solid #6b705c")]},
        "header": {
            "props": [
        ...
        "row_heading": {
            "props": [("background-color", "#1b4332"), ("color", "#b7e4c7")]
        },
        "row": {"props": [("background-color", "#1b4332"), ("color", "#d8f3dc")]},
        "alt_row": {"props": [("background-color", "#2d6a4f")]},
        "hover": {
            "props": [
    ...
    "blue_gray": {
        "table": {"props": [("border", "1px solid #4c566a")]},
        "header": {
            "props": [
        ...
        "row_heading": {
            "props": [("background-color", "#2e3440"), ("color", "#81a1c1")]
        },
        "row": {"props": [("background-color", "#2e3440"), ("color", "#d8dee9")]},
        "alt_row": {"props": [("background-color", "#3b4252")]},
        "hover": {
            "props": [
    ...
    "neutral_dark": {
        "table": {"props": [("border", "1px solid #333333")]},
        "header": {
            "props": [
        ...
        "row_heading": {
            "props": [("background-color", "#121212"), ("color", "#b0b0b0")]
        },
        "row": {"props": [("background-color", "#121212"), ("color", "#e0e0e0")]},
        "alt_row": {"props": [("background-color", "#1e1e1e")]},
        "hover": {
            "props": [
...
def get_style(theme_name):
    ...
    if theme_name not in style_guide and theme_name != "random":
        theme_name = random.choice(
            [
                "gruvbox_dark",
                "gruvbox_colorful",
    ...
    theme = get_random_theme() if theme_name == "random" else style_guide[theme_name]
...
def get_legible_hex(h, l, s):
    r, g, b = colorsys.hls_to_rgb(h, l, s)
    return "#{:02x}{:02x}{:02x}".format(int(r * 255), int(g * 255), int(b * 255))


def get_random_theme(vibrancy=0.1):
    ...
    colors = {
        "bg": get_legible_hex(base_hue, bg_l, sat_base * 0.5),
        "text": get_legible_hex(base_hue, text_l, sat_base * 0.2),
        "accent": get_legible_hex(base_hue, 0.5, sat_accent),
        "alt_bg": get_legible_hex(base_hue, alt_l, sat_base * 0.5),
    }
    ...
    return {
        "table": {"props": [("border", f"1px solid {colors['accent']}")]},
        "header": {
            "props": [
        ...
        "col_heading": {
            "props": [
                ("background-color", colors["alt_bg"]),
                ("color", colors["accent"]),
                ("font-size", "16px"),
            ]
        },
        "row_heading": {
            "props": [("background-color", colors["bg"]), ("color", colors["accent"])]
        },
        "row": {
            "props": [("background-color", colors["bg"]), ("color", colors["text"])]
        },
        "alt_row": {"props": [("background-color", colors["alt_bg"])]},
        "hover": {
            "props": [
