...
THEME_REGISTRY: Dict[str, ThemeConfig] = {
    ...
    "quilt_patch": ThemeConfig(
        ...
        custom_css_vars={
            ...
            "--dgcv-special-background": "repeating-linear-gradient(0deg, #8a7048 0 1px, transparent 1px 22px), repeating-linear-gradient(90deg, #8a7048 0 1px, transparent 1px 22px), conic-gradient(#7a2a2a 0 25%, #1f5a52 25% 50%, #243a6a 50% 75%, #6a4a1e 75% 100%) 0 0 / 22px 22px, #7a2a2a",
            "--dgcv-hover-transform": "scale(1.001)",
            "--dgcv-hover-transition": "all 0.2s ease",
        },
    ),
    ...
    "quilt_denim": ThemeConfig(
        ...
        custom_css_vars={
            ...
            "--dgcv-special-background": "repeating-linear-gradient(0deg, #4e6e98 0 1px, transparent 1px 18px), repeating-linear-gradient(90deg, #4e6e98 0 1px, transparent 1px 18px), repeating-linear-gradient(45deg, rgba(255,255,255,0.05) 0 1px, transparent 1px 4px), repeating-linear-gradient(-45deg, rgba(0,0,0,0.06) 0 1px, transparent 1px 5px), conic-gradient(from 0deg, #20405f 0 25%, #2a4e78 25% 50%, #20405f 50% 75%, #2a4e78 75% 100%) 0 0 / 36px 36px, #22425f",
