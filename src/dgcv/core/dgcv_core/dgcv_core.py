...
from ..._aux._vmf.vmf import clearVar, order_coordinates, vmf_lookup
from ..._aux.printing.printing import (
    _unwrap_math_delims,
    tensor_field_latex2,
    tensor_field_printer2,
)
from ..arrays.arrays import _spool, array_dgcv, matrix_dgcv
from ..base import dgcv_class
from ..combinatorics.combinatorics import build_nd_array, carProd, permSign
...
class tensor_field_class(dgcv_class):
    ...
    def _compute_nd_decomp(self):
        from ..._aux._backends._symbolic_router import as_numer_denom, expand
    ...
    def _process_coeffs_dict_new(
        ...
        def _sort_slot_key(slot):
            ...
            idx_key = int(idx) if isinstance(idx, Number) else idx  ###!!!
...
class differential_operator(dgcv_class):
    ...
    def _repr_latex_(self, raw=False, **kwargs):
        ...
        from ..._aux.printing.printing._class_printers import _tf2_latex_coeff
...
def DGCVPolyClass(polyExpr, varSpace=None, degreeUpperBound=None):
    dgcv_warning(
        ...
        dgcvDeprecationWarning,
        stacklevel=2,
        old_kw="DGCVPolyClass",
        new_kw="polynomial_dgcv",
        sunset="2026",
    )
    return polynomial_dgcv(
        polyExpr,
